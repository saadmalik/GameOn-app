...
module.exports = function(){
  ...
  for (var i = 0; i < 20; i++) {
    var gameObject = gamesList[0]; //Temporary; needs to be more modularly laid out later
    ...
    var sportIcon = Ti.UI.createImageView({
      image: 'images/'+gameObject.sport+'-icon.png',
      top: 37,
      left: '1%',
      height: 29,
      zIndex: 99
    ...
    var profilePhoto = Ti.UI.createImageView({
      image: gameObject.nearby_user.photo,
      width: 49,
      height: 50,
      left:'7%',
      top:'7%',
    ...
    var userFullName = Ti.UI.createLabel({
      text: gameObject.nearby_user.name,
      left:'30%',
      top:'3%',
